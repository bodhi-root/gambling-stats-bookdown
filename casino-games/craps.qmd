...
We discussed [rolling dice](#rolling-dice) earlier. To recap a bit, if we roll two dice and add the numbers together, the probabilities for the various outcomes are:
