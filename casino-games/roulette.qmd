...
Roulette is a fun and simple game where a large wheel is spun and then a ball is dropped onto the wheel. Players bet on where the ball will land. The main numbers range from 1 to 36 and are divided into half red and half black. There is also an additional number, zero, that is neither red nor black (nor is it even or odd). In most games, you will find two of these special numbers: zero (0) and double zero (00). The presence of these numbers is what gives the house its edge in the game. With two of these special numbers, they have a bigger edge than with one.
...
* Eighteen numbers, 1-18 or 19-36, paying 1-to-1
